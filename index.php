...
<div class="container">
    ...
    <h1>Welcome to Car Exploration</h1>
    <div class="car-details" id="models">
        <div class="car-container">
            <img src="images/mercedes.jpeg" alt="Car Image1">
            <ul>
        ...
        <div class="car-container">
            <img src="images/rolls-ryce.jpeg" alt="Car Image2">
            <ul>
                <li>Name: ROLLS-RYCE</li>
              <li>Date of Manufacture: 2022-01-01</li>
              <li>Country of Origin: Japan</li>
              <li>Mileage: 10,000 km</li>
            </ul>
        ...
        <div class="car-container">
            <img src="images/2023-Chevrolet-Corvette.jpg" alt="Car Image3">
            <ul>
                <li>Name: 2023-CHEVROLET-CORVETTE</li>
                <li>Date of Manufacture: 2022-01-01</li>
                <li>Country of Origin: Japan</li>
                <li>Mileage: 10,000 km</li>
            </ul>
        ...
        <div class="car-container">
            <img src="images/bent-aston.jpeg" alt="Car Image4">
            <ul>
                <li>Name: BENTlEY</li>
                <li>Date of Manufacture: 2022-01-01</li>
                <li>Country of Origin: Japan</li>
        ...
        <div class="car-container">
            <img src="images/backiee-247382.jpg" alt="Car Image5">
            <ul>
                <li>Name: BUGATTI</li>
                <li>Date of Manufacture: 2022-01-01</li>
                <li>Country of Origin: Japan</li>
        ...
        <div class="car-container">
            <img src="images/backiee-246142.jpg" alt="Car Image6">
            <ul>
                <li>Name: AUDI</li>
                <li>Date of Manufacture: 2022-01-01</li>
                <li>Country of Origin: Japan</li>
        ...
        <div class="car-container">
            <img src="images/backiee-132473.jpg" alt="Car Image7">
            <ul>
                <li>Name: BACKIEE</li>
                <li>Date of Manufacture: 2022-01-01</li>
                <li>Country of Origin: Japan</li>
        ...
        <div class="car-container">
            <img src="images/mustang.jpeg" alt="Car Image8">
            <ul>
                <li>Name: MUSTANG</li>
                <li>Date of Manufacture: 2022-01-01</li>
                <li>Country of Origin: Japan</li>
        ...
        <div class="car-container">
            <img src="images/BMW-jeep-maserati.jpeg" alt="Car Image8">
            <ul>
                <li>Name: BMW-JEEP-MASERATI</li>
                <li>Date of Manufacture: 2022-01-01</li>
                <li>Country of Origin: Japan</li>
                <li>Mileage: 10,000 km</li>
            </ul>
                    ...
                    <div class="testimonials">
                        <div class="testimonial-box">
                            <div class="testimonial-img">
                                <img src="images/images/clients/c1.png" alt="Image of Client" />
                            </div>
                        ...
                        <div class="testimonial-box">
                            <div class="testimonial-img">
                                <img src="images/images/clients/c2.png" alt="Image of Client" />
                            </div>
                            <div class="testimonial-person">
                        ...
                        <div class="testimonial-box">
                            <div class="testimonial-img">
                                <img src="images/images/clients/c3.png" alt="Image of Client" />
                            </div>
                            <div class="testimonial-person">
		...
		<section id="brand"  class="brand">
			<div class="brand-container" id="logos">
				<div class="brand-area">
						<div class="item">
							<a href="#">
								<img src="images/images/brand/br1.png" alt="brand-image" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
								<img src="images/images/brand/br2.png" alt="brand-image" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
								<img src="images/images/brand/br3.png" alt="brand-image" />
							</a>
						</div><!--/.item-->
						<div class="item">
							<a href="#">
								<img src="images/images/brand/br4.png" alt="brand-image" />
							</a>
						</div><!--/.item-->

						<div class="item">
							<a href="#">
								<img src="images/images/brand/br5.png" alt="brand-image" />
							</a>
						</div><!--/.item-->

						<div class="item">
							<a href="#">
								<img src="images/images/brand/br6.png" alt="brand-image" />
							</a>
						</div><!--/.item-->
				</div><!--/.clients-area-->
    ...
    <footer class="grid-container">
        ...
        <div class="social-icons">
            ...
            <i class="fa-brands fa-facebook-official" aria-hidden="true"></i>
